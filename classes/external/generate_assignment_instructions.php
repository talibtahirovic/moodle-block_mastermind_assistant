...
class generate_assignment_instructions extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            ...
            'assignmentname' => new external_value(PARAM_TEXT, 'Assignment name', VALUE_DEFAULT, ''),
            'assignmentdescription' => new external_value(PARAM_RAW, 'Assignment description', VALUE_DEFAULT, ''),
            'assignmenttype' => new external_value(PARAM_TEXT, 'Assignment type', VALUE_DEFAULT, ''),
            'academiclevel' => new external_value(PARAM_TEXT, 'Academic level', VALUE_DEFAULT, ''),
            'scopelength' => new external_value(PARAM_TEXT, 'Scope/length expectation', VALUE_DEFAULT, ''),
    ...
    public static function execute(
        ...
        try {
            ...
            return [
                ...
                'key_requirements' => json_encode($response['key_requirements'] ?? []),
                'rubric_criteria' => json_encode($response['rubric_criteria'] ?? []),
    ...
    public static function execute_returns() {
        return new external_single_structure([
            ...
            'content' => new external_value(PARAM_RAW, 'Generated assignment instructions HTML'),
            'title' => new external_value(PARAM_TEXT, 'Optional improved title'),
            'estimated_time' => new external_value(PARAM_TEXT, 'Estimated completion time'),
            'key_requirements' => new external_value(PARAM_RAW, 'JSON array of key requirements'),
            'rubric_criteria' => new external_value(PARAM_RAW, 'JSON array of rubric criteria'),
            'learning_outcomes' => new external_value(PARAM_RAW, 'JSON array of learning outcomes'),
